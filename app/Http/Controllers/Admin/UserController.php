...
class UserController extends Controller
{
    ...
    {
        $all_users = User::with(['shift', 'department', 'role', 'personalInfo', 'contactInfo', 'professionalDetails', 'jobInfo.department', 'compensationInfo', 'additionalInfo','accountInfo','overTime','userLocations.location'])->where('role_id','!=',1)->get();
