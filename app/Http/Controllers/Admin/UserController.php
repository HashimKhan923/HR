...
class UserController extends Controller
{
    ...
    {
        $all_users = User::with(['shift', 'department', 'role', 'personalInfo', 'contactInfo', 'professionalDetails', 'jobInfo.department', 'compensationInfo', 'additionalInfo','accountInfo','overTime','userLocation.location'])->where('role_id','!=',1)->get();
    ...
    {
        $data = User::with(['shift', 'department', 'role', 'personalInfo', 'contactInfo', 'professionalDetails', 'jobInfo','compensationInfo', 'additionalInfo','accountInfo','leaveBalance','userLocation.location','overTime'])
                    ->where('id', $id)
                    ->firstOrFail();
