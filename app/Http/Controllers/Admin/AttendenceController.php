...
class AttendenceController extends Controller
{
    ...
    {
        $attendences = Time::query()->with('user.personalInfo','user.jobInfo','attendenceRequest'); // Initialize query with relationship
        ...
        ->map(function ($attendance) {
            ...
            return $attendance;
                ...
                $users = User::with('personalInfo','jobInfo')->where('role_id',2)->get();
